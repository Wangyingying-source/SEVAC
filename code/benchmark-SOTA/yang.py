...
def MIP_LR(mymap, S, T, phi=5, e=1):
    ...
    while(True):
        ...
        for w in range(S):
            ...
            d_cost, path, x, node_list = func.dijkstra(mymap.G, mymap.r_0, mymap.r_s, ext_weight=samples_tmp)
    ...
    print("final path:" + str(np.array(node_list)))
    return up, up_path, node_list

...
if __name__ == '__main__':
    ...
    map1 = MapInfo("./nn/Winnipeg/Winnipeg_network.csv")
    # map1 = MapInfo("D:/SE-GAC-master/nn/Anaheim/Anaheim_network.csv")
    # map1 = MapInfo("D:/GE-GAC/GE-GAC/nn/Chicago_Sketch/Chicago_Sketch_network. csv")
    # mymap = FMA_MAP()
    # mymap = Map()
